...
We assembled $n = 4{,}683$ non-English books from Gutenberg across 19 languages and 10 language families. Books were encoded with LaBSE and projected into the *English* PCA-128 basis fit in §31.4. The channels were then recomputed in this shared basis, and each channel's values were correlated across languages on book-title-matched bundles (same book, different languages).
